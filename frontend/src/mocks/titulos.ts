...
export const mockTitulosReceber: TituloReceber[] = [
  ...
  },
  {
    ...
    usuario_nome: 'Carlos Eduardo Silva',
    tipo: 'servico',
    descricao: 'Horas extras – Maio 2026',
    num_parcela: 1,
    total_parcelas: 1,
    valor: 560,
    valor_pago: 0,
  ...
  },
  {
    ...
    usuario_nome: 'Marcos Costa',
    tipo: 'servico',
    descricao: 'Adiantamento salarial – Maio 2026',
    num_parcela: 1,
    total_parcelas: 1,
    valor: 1300,
    valor_pago: 1300,
  ...
  },
  {
    ...
    usuario_nome: 'Ana Paula Santos',
    tipo: 'servico',
    descricao: 'Comissão de instrução – Abril 2026',
    num_parcela: 1,
    total_parcelas: 1,
    valor: 680,
    valor_pago: 680,
  ...
  },
  {
    ...
    usuario_nome: 'Ana Paula Santos',
    tipo: 'servico',
    descricao: 'Comissão de instrução – Maio 2026',
    num_parcela: 1,
    total_parcelas: 1,
    valor: 720,
    valor_pago: 0,
